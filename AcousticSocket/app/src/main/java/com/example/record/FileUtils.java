...
public class FileUtils {
    ...
    private  static String rootPath="pauseRecordDemoSocket";
    //原始文件(不能播放)
    ...
    public static byte[] getWAVFileByte(String absoulateFilePath)throws IOException {
        //读SD中的文件
        byte[] res=null;
        try{
            FileInputStream fin = new FileInputStream(absoulateFilePath);
